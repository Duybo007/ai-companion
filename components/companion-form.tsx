...
function CompanionForm({ initialData, categories}: CompanionDataProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      if(initialData) { // Update functionality
        await axios.patch(`/api/companion/${initialData.id}`, values)
      } else { //Create companion 
  ...
  return (
    <div className="h-full p-3 space-y-2 max-w-3xl mx-auto">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10 pb-10">
            ...
            <FormField 
              ...
              render={({field}) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is what you will call your AI pal.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField 
              ...
              render={({field}) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    Short description for your AI pal.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField 
              ...
              render={({field}) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    Select a category for your AI pal.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField 
            ...
            <div className="w-full flex justify-center">
                ...
                size="lg"
                disabled={isLoading}>
                  {initialData? "Edit your AI pal" : "Create your AI pal"}
